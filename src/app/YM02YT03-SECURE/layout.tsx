...
const ADMIN_NAV = [
  {
    href: "/YM02YT03-SECURE", label: "Tableau de Bord",
  ...
  {
    href: "/YM02YT03-SECURE/rackets", label: "Raquettes",
  ...
  {
    href: "/YM02YT03-SECURE/submissions", label: "Soumissions",
  ...
  {
    href: "/YM02YT03-SECURE/brands", label: "Marques",
  ...
  {
    href: "/YM02YT03-SECURE/analytics", label: "Analytiques",
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  if (pathname === "/YM02YT03-SECURE/YM02YT03-secure") return <>{children}</>;

  async function handleLogout() {
    await fetch("/api/auth/logout", { method: "POST" });
    router.push("/YM02YT03-SECURE/YM02YT03-secure");
    router.refresh();
  }
    ...
    <div data-admin className="min-h-screen flex" style={{ background: "#0f1117" }}>
      ...
      <aside className="w-64 hidden md:flex flex-col border-r border-white/8" style={{ background: "#13151c" }}>
        ...
        <div className="p-5 border-b border-white/8">
          <Link href="/YM02YT03-SECURE" className="flex items-center">
            <div>
          ...
          <div className="flex items-center justify-between mb-6 pb-6 border-b border-white/8">
            <div className="flex items-center gap-2 text-sm text-white/30">
              ...
              <span className="text-white/60 capitalize">
                {pathname === "/YM02YT03-SECURE" ? "Tableau de Bord" : pathname.split("/YM02YT03-SECURE/")[1] || ""}
              </span>
            </div>
            <button onClick={handleLogout}
