...
export async function GET() {
  try {
    ...
    return apiSuccess({
      ...
      submissions: { total: totalSubmissions, pending: pendingSubmissions, recentWeek: recentSubmissions },
      contacts: { total: totalContacts, unread: unreadContacts, recentWeek: recentContacts },
